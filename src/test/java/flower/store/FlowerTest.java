...
public class FlowerTest {
    ...
    private static final FlowerColor INITIAL_COLOR = 
    FlowerColor.RED;
    private static final double INITIAL_PRICE = 20.0;
    private static final FlowerType INITIAL_FLOWER_TYPE = 
    FlowerType.ROSE;
    private static final double TEST_SEPAL_LENGTH = 3.5;
    private static final FlowerType TEST_FLOWER_TYPE = 
    ...
    public void testFlowerType() {
        ...
        Assertions.assertEquals(TEST_FLOWER_TYPE,
                flower.getFlowerType());
    }

    @Test
    public void testAllArgsConstructor() {
        Flower testFlower = new Flower(INITIAL_SEPAL_LENGTH,
                INITIAL_COLOR,
                INITIAL_PRICE, INITIAL_FLOWER_TYPE);
        Assertions.assertEquals(INITIAL_SEPAL_LENGTH,
                testFlower.getSepalLength());
        Assertions.assertEquals(INITIAL_COLOR.getCode(),
                testFlower.getColor());
        Assertions.assertEquals(INITIAL_PRICE,
                testFlower.getPrice());
        Assertions.assertEquals(INITIAL_FLOWER_TYPE,
                testFlower.getFlowerType());
    }
}
