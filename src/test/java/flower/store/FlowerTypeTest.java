...
public class FlowerTypeTest {
    ...
    public void testRoseAllArgsConstructor() {
        rose = new Rose(ROSE_SEPAL_LENGTH,
                ROSE_COLOR, ROSE_PRICE);
        Assertions.assertEquals(ROSE_SEPAL_LENGTH,
                rose.getSepalLength());
        Assertions.assertEquals(ROSE_COLOR.getCode(),
                rose.getColor());
    ...
    public void testTulipAllArgsConstructor() {
        tulip = new Tulip(TULIP_SEPAL_LENGTH,
                TULIP_COLOR, TULIP_PRICE);
        Assertions.assertEquals(TULIP_SEPAL_LENGTH,
                tulip.getSepalLength());
        Assertions.assertEquals(TULIP_COLOR.getCode(),
                tulip.getColor());
        Assertions.assertEquals(TULIP_PRICE,
                tulip.getPrice());
    ...
    public void testChamomileAllArgsConstructor() {
        chamomile = new Chamomile(CHAMOMILE_SEPAL_LENGTH,
                CHAMOMILE_COLOR, CHAMOMILE_PRICE);
        Assertions.assertEquals(CHAMOMILE_SEPAL_LENGTH,
                chamomile.getSepalLength());
        Assertions.assertEquals(CHAMOMILE_COLOR.getCode(),
                chamomile.getColor());
        Assertions.assertEquals(CHAMOMILE_PRICE,
                chamomile.getPrice());
    ...
    public void testFlowerTypeEnumValues() {
        FlowerType[] expectedTypes = 
                { FlowerType.CHAMOMILE, FlowerType.ROSE,
                    FlowerType.TULIP };
        Assertions.assertArrayEquals(expectedTypes,
                FlowerType.values());
    }
